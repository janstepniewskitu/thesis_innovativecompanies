...
ab1 = AdaBoostClassifier(n_estimators=50)
classifiers.append(ab1)
ab2 = AdaBoostClassifier(n_estimators=100)
classifiers.append(ab2)
ab3 = AdaBoostClassifier(n_estimators=200)
classifiers.append(ab3)
ab4 = AdaBoostClassifier(n_estimators=300)
classifiers.append(ab4)
ab5 = AdaBoostClassifier(n_estimators=500)
