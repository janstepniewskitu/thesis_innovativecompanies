...
classifiers = []
ab = RandomForestClassifier(n_estimators=10)
classifiers.append(ab)
ab1 = RandomForestClassifier(n_estimators=50)
classifiers.append(ab1)
ab2 = RandomForestClassifier(n_estimators=100)
classifiers.append(ab2)
ab3 = RandomForestClassifier(n_estimators=200)
classifiers.append(ab3)
ab4 = RandomForestClassifier(n_estimators=300)
classifiers.append(ab4)
ab5 = RandomForestClassifier(n_estimators=500)
classifiers.append(ab5)
